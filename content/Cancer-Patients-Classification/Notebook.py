#%% md
# ### In this task we have to classify patients (Dead or Alive) based on some medical data we have
# ---
# [Task Link](https://judge.nitro-ai.org/roai-2025/simulare-ojia-2/problems/1/task)
#%%
import pandas as pd
...
# ```json
# {
# "Tags": ["Binary Classification", "RF", "Feature Engineering"]
# }
# ```